...
-- 5. Дать список последних проживавши х клиентов по всем комнатам гостиницы “Космос”, выехавшим в апреле с указанием даты выезда
...
-- 8. Создать бронированиев транзакции

BEGIN TRANSACTION
  INSERT INTO client (name, phone) VALUES ('Алексей Попов', '7(99)999-99-99');
  INSERT INTO booking (id_client, booking_date) (SELECT id_client, '2021-03-17' FROM client WHERE name = 'Алексей Попов' AND phone = '7(99)999-99-99');
  INSERT INTO room_in_booking (id_booking, id_room, checkin_date, checkout_date)
    ...
    (SELECT id_client FROM client WHERE name = 'Алексей Попов' AND phone = '7(99)999-99-99')));
COMMIT TRANSACTION;
